...
//    Hand is 2, 3, 4, 5, 5 -- all spades
    ...
    XCTAssertEqual(hand.score, 0, @"Hand score should be 0, as the jokers allow the meld 2, 3, 4, 5-as-5, 5-as-6");
}
...
- (void)testHand1
{
    ...
    XCTAssertEqual(testHand1.score, 11, @"The best score for this hand is 11");
}
...
- (void)testHand2
{
    ...
    XCTAssertEqual(testHand2.score, 0, @"This is a winning hand with two jokers");
}
...
- (void)testHand3 {
    ...
    XCTAssertEqual(testHand3.score, 1, @"This hand can form a meld of 4 (joker), and 10 and 11 of hearts");
}
